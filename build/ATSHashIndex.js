...
class ATSHashIndex {
  ...
  */
	fromSchema(schema) {
		...
		if ("hashIndAlgorithm" in asn1.result) this.hashIndAlgorithm = new _pkijs.AlgorithmIdentifier({ schema: asn1.result.hashIndAlgorithm });
		//endregion
...
exports.default = ATSHashIndex; //**************************************************************************************
//# sourceMappingURL=ATSHashIndex.js.map
...
class ArchiveTimeStampV3 extends _pkijs.ContentInfo {
  ...
  constructor(parameters = {}) {
     ...
     */
    this.aTSHashIndex = (0, _pvutils.getParametersValue)(
      parameters,
      "aTSHashIndex",
    ...
    switch (memberName) {
      ...
      case "aTSHashIndex":
        ...
        return (
          ...
          _ATSHashIndex2.default.compareWithDefault(
  ...
  fromSchema(schema, initValues = true) {
    ...
    if (initValues) {
      ...
      try {
        parsedValue = new _ATSHashIndex2.default({
        ...
        if (
          ...
          if (
            ...
            for (
              ...
              content = (0, _pvutils.utilConcatBuf)(
                content,

...
class RevocationInfoArchival {
  ...
  constructor(parameters = {}) {
    ...
    if ("crl" in parameters)
       ...
       * @description crl
       */
      this.crl = (0, _pvutils.getParametersValue)(
        parameters,
        "crl",
    ...
    if ("ocsp" in parameters)
       ...
       * @description ocsp
       */
      this.ocsp = (0, _pvutils.getParametersValue)(
        parameters,
        "ocsp",
    ...
    if ("otherRevInfo" in parameters)
       ...
       */
      this.otherRevInfo = (0, _pvutils.getParametersValue)(
        parameters,
        "otherRevInfo",
  ...
  fromSchema(schema) {
    ...
    if ("ocsp" in asn1.result)
      this.ocsp = Array.from(
        asn1.result.ocsp,
        (element) => new _pkijs.OCSPResponse({ schema: element })
      );

    if ("otherRevInfo" in asn1.result)
      this.otherRevInfo = new _OtherRevVals2.default({

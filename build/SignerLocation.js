...
class SignerLocation {
  ...
  */
	fromSchema(schema) {
		...
		if ("countryName" in asn1.result) this.countryName = new _DirectoryString2.default({ schema: asn1.result.countryName });

		if ("localityName" in asn1.result) this.localityName = new _DirectoryString2.default({ schema: asn1.result.localityName });

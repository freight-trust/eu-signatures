...
class CrlOcspRef {
  ...
  */
	fromSchema(schema) {
		...
		if ("crlids" in asn1.result) this.crlids = new _CRLListID2.default({ schema: asn1.result.crlids.valueBlock.value[0] });

		if ("ocspids" in asn1.result) this.ocspids = new _OcspListID2.default({ schema: asn1.result.ocspids.valueBlock.value[0] });

		if ("otherRev" in asn1.result) this.otherRev = new _OtherRevRefs2.default({ schema: asn1.result.otherRev.valueBlock.value[0] });
		//endregion
	}
	//**********************************************************************************
	/**

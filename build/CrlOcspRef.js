...
class CrlOcspRef {
  ...
  constructor(parameters = {}) {
    ...
    if ("crlids" in parameters)
       ...
       * @description crlids
       */
      this.crlids = (0, _pvutils.getParametersValue)(
        parameters,
        "crlids",
    ...
    if ("ocspids" in parameters)
       ...
       * @description ocspids
       */
      this.ocspids = (0, _pvutils.getParametersValue)(
        parameters,
        "ocspids",
    ...
    if ("otherRev" in parameters)
       ...
       */
      this.otherRev = (0, _pvutils.getParametersValue)(
        parameters,
        "otherRev",
  ...
  static compareWithDefault(memberName, memberValue) {
    switch (memberName) {
      ...
      case "ocspids":
        return _OcspListID2.default.compareWithDefault(
          "ocspResponses",
          memberValue.ocspResponses
        );
      case "otherRev":
        return (
          _OtherRevRefs2.default.compareWithDefault(
            "otherRevRefType",

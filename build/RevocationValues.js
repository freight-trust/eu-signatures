...
class RevocationValues {
  ...
  constructor(parameters = {}) {
    ...
    if ("crlVals" in parameters)
       ...
       * @description crlVals
       */
      this.crlVals = (0, _pvutils.getParametersValue)(
        parameters,
        "crlVals",
    ...
    if ("ocspVals" in parameters)
       ...
       */
      this.ocspVals = (0, _pvutils.getParametersValue)(
        parameters,
        "ocspVals",
    ...
    if ("otherRevVals" in parameters)
       ...
       */
      this.otherRevVals = (0, _pvutils.getParametersValue)(
        parameters,
        "otherRevVals",
  ...
  fromSchema(schema) {
    ...
    if ("crlVals" in asn1.result)
      this.crlVals = Array.from(
        asn1.result.crlVals,
        (element) => new _pkijs.CertificateRevocationList({ schema: element })
      );

    if ("ocspVals" in asn1.result)
      this.ocspVals = Array.from(
        asn1.result.ocspVals,
        (element) => new _pkijs.BasicOCSPResponse({ schema: element })
      );

    if ("otherRevVals" in asn1.result)
      this.otherRevVals = new _OtherRevVals2.default({

...
class OcspIdentifier {
  ...
  */
	fromSchema(schema) {
		...
		if (asn1.result.ocspResponderID.idBlock.tagNumber === 1) this.ocspResponderID = new _pkijs.RelativeDistinguishedNames({ schema: asn1.result.ocspResponderID.valueBlock.value[0] });else this.ocspResponderID = asn1.result.ocspResponderID.valueBlock.value[0]; // OCTETSTRING
...
exports.default = OcspIdentifier; //**************************************************************************************
//# sourceMappingURL=OcspIdentifier.js.map